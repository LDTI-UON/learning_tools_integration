...
$hook_method = function($args) {
    ...
    $type = $args[2];
      ...
      if(is_readable($lti_cache.$this->context_id.$this->institution_id.$this->course_id
      ...
      ResourceFile::_push_file($lti_cache.$this->context_id.$this->institution_id.$this->course_id.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.$filename,
