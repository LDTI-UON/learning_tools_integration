...
if(ee()->input->post('process')) {
        ...
        $rfile = new ResourceFile($lti_cache.ee()->input->post('process'), $this->internal_context_id, $this->context_id, $this->institution_id, $this->course_id, $is->problem_prefix, $is->solution_prefix);
        $feed = $rfile->import();
